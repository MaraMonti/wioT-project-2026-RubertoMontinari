...
| **Gateway / ML Service** | Contiene il Modello ML e l'App Streamlit (questo repository). | **https://https://github.com/MaraMonti/wioT-project-2025-RubertoMontinari-gateway-ml** |
