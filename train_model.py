...
# df = pd.read_csv("file_ripulito.csv")
#
# # 3. Definisci le feature e il target
# features = ['Temperature', 'Humidity', 'hour', 'day_of_week', 'month', 'day_of_year', 'week_of_year', 'is_weekend']
...
# #
# # # 5. Salva il modello su disco
# # joblib.dump(model, "rf_energy_model.joblib")
# # # Dopo il training...
# # joblib.dump((X_test, y_test), "test_data.joblib")
# #
# # print("✅ Modello salvato correttamente come 'rf_energy_model.joblib'")
# #
#
...
# joblib.dump((X_test, y_test), "test_data.joblib")
#
# print(f"\n✅ Miglior modello: {best_name} (salvato come 'best_energy_model.joblib')")
